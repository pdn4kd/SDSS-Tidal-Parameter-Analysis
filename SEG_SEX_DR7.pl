...
open my $aper_all, '>', "seg_all_DR7.sh" or die "cannot open seg_all_DR7.sh $!";


foreach my $posCount (0 .. @nyuID - 1)
#scalar @nyuID - 1
{
	open my $SEXaper_r, '>', "p$nyuID[$posCount]_DR7.seg.sex" or die "cannot open p$nyuID[$posCount].seg.sex $!";
...
CATALOG_NAME     p$nyuID[$posCount]_DR7.seg.cat  # name of the output catalog
...
CHECKIMAGE_TYPE  SEGMENTATION   # can be NONE, BACKGROUND, BACKGROUND_RMS,
                                ...
                                # or APERTURES
CHECKIMAGE_NAME  p$nyuID[$posCount]_DR7.seg.fits     # Filename for the check-image
...
print $aper_all "sex p$nyuID[$posCount]_DR7.fits -c p$nyuID[$posCount]_DR7.seg.sex \n";
print "sex p$nyuID[$posCount]_DR7.fits -c p$nyuID[$posCount]_DR7.seg.sex \n";
