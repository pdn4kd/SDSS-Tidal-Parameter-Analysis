...
print "${nyuID[$posCount]}_S82.fits\n";

#NEW MASK USING SEXTRACTOR
open my $inPositions, '<', "COLDMASK.p${nyuID[$posCount]}_S82.csv" or die "cannot open COLDMASK.p${nyuID[$posCount]}_S82.csv: $!";
...
$ellipse->wfits("mask_1a.p${nyuID[$posCount]}_S82.fits");  
$ellipse_2->wfits("mask_1b.p${nyuID[$posCount]}_S82.fits"); 

my $Mimage = rfits("mask_1b.p${nyuID[$posCount]}_S82.fits");
...
$Un_masked->wfits("mask_1.p${nyuID[$posCount]}_S82.fits");
