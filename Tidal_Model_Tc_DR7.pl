...
open my $inPositions, '<', "result_DR7.csv" or die "cannot open result.csv: $!";
...
open my $T_plot, '>', "Tc_DR7.csv" or die "cannot open Tc_DR7.csv $!"; # Tp table
print $T_plot "ID,Fit_Type,Tp,Tm,Tc\n";
#open my $displ, '>', "displ_DR7.cl" or die "cannot open displ.cl $!"; #Galaxy image check
...
#model images
my $Gimage_1 = rfits("mp${nyuID[$posCount]}_DR7.model_$galaxy_fits.fits[1]"); #normal
my $Mimage_1 = rfits("mp${nyuID[$posCount]}_DR7.model_$galaxy_fits.fits[2]");

#residual images
my $residual_M = $Gimage_1 - $Mimage_1 * $Mask_1b;
#$residual_M->where($residual <= -1 ) .= 0;
$residual_M -> wfits("residual.mp${nyuID[$posCount]}_DR7_$galaxy_fits.fits"); #residual image
...
print "The critical tidal parameter for ${nyuID[$posCount]}_DR7 is $Tc\n";

print $T_plot "${nyuID[$posCount]}_DR7,$galaxy_fits,$Tp,$Tm,$Tc\n";
...
#$T_image->where($full_mask <= -1 ) .= 0;
$T_image_1 -> wfits("Timage.mp${nyuID[$posCount]}_DR7_$galaxy_fits.fits"); #normal
#
#
...
#print $displ "displ mp${nyuID[$posCount]}_DR7.model_1.fits[1] 6\n";
#print $displ "displ mp${nyuID[$posCount]}_DR7.model_1.fits[2] 7\n";
#print $displ "displ mp${nyuID[$posCount]}_DR7.model_1.fits[3] 8\n";
#print $displ "displ residual.mp${nyuID[$posCount]}_DR7.fits 9\n";
#print $displ "displ Timage.mp${nyuID[$posCount]}_DR7.fits 10\n";
#print $displ "imexam\n";
}
}
}
