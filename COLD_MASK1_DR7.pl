...
open my $inPositions, '<', "COLDMASK.p${nyuID[$posCount]}_DR7.csv" or die "cannot open COLDMASK.p${nyuID[$posCount]}_DR7.csv: $!";
...
$ellipse->wfits("mask_1a.p${nyuID[$posCount]}_DR7.fits");  
$ellipse_2->wfits("mask_1b.p${nyuID[$posCount]}_DR7.fits"); 

my $Mimage = rfits("mask_1b.p${nyuID[$posCount]}_DR7.fits");
...
$Un_masked->wfits("mask_1.p${nyuID[$posCount]}_DR7.fits");
