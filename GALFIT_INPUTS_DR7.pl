...
open my $galfit_batch, '>', "GALFIT_BATCH_DR7.sh" or die "cannot open GALFIT_BATCH.sh: $!";
...
B) p$nyuID[$galCount]_DR7.model_1.fits      # Output data image block
...
# IMAGE and GALFIT CONTROL PARAMETERS
A) MASKED.p$nyuID[$galCount]_DR7.fits      # Input data image (FITS file)
B) p$nyuID[$galCount]_DR7.model_2.fits      # Output data image block
C) #                   # Sigma image name (made from data if blank or "none") 
D) scpsf.$nyuID[$galCount]_DR7.fits           # Input PSF image and (optional) diffusion kernel
E) 1                  # PSF fine sampling factor relative to data 
F) FMASK.p$nyuID[$galCount]_DR7.fits      # Bad pixel mask (FITS image or ASCII coord list)
...
# IMAGE and GALFIT CONTROL PARAMETERS
A) MASKED.p$nyuID[$galCount]_DR7.fits      # Input data image (FITS file)
B) p$nyuID[$galCount]_DR7.model_4.fits      # Output data image block
C) #                   # Sigma image name (made from data if blank or "none") 
D) scpsf.$nyuID[$galCount]_DR7.fits           # Input PSF image and (optional) diffusion kernel
E) 1                  # PSF fine sampling factor relative to data 
F) FMASK.p$nyuID[$galCount]_DR7.fits      # Bad pixel mask (FITS image or ASCII coord list)
...
# IMAGE and GALFIT CONTROL PARAMETERS
A) MASKED.p$nyuID[$galCount]_DR7.fits      # Input data image (FITS file)
B) p$nyuID[$galCount]_DR7.model_a.fits      # Output data image block
C) #                   # Sigma image name (made from data if blank or "none") 
D) scpsf.$nyuID[$galCount]_DR7.fits           # Input PSF image and (optional) diffusion kernel
E) 1                  # PSF fine sampling factor relative to data 
F) FMASK.p$nyuID[$galCount]_DR7.fits      # Bad pixel mask (FITS image or ASCII coord list)
...
# IMAGE and GALFIT CONTROL PARAMETERS
A) MASKED.p$nyuID[$galCount]_DR7.fits      # Input data image (FITS file)
B) p$nyuID[$galCount]_DR7.model_14.fits      # Output data image block
C) #                   # Sigma image name (made from data if blank or "none") 
D) scpsf.$nyuID[$galCount]_DR7.fits           # Input PSF image and (optional) diffusion kernel
E) 1                  # PSF fine sampling factor relative to data 
F) FMASK.p$nyuID[$galCount]_DR7.fits      # Bad pixel mask (FITS image or ASCII coord list)
