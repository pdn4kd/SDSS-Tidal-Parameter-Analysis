...
if (-e "p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.csv") {
open my $file_in, '<', "p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.csv" or die "Unable to p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.csv: $!\n";	
...
open my $file_in1, '<', "p${nyuID[$posCount]}_DR7.aper.csv" or die "Unable to p${nyuID[$posCount]}_DR7.aper.csv: $!\n";
