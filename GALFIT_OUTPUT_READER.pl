...
my $file = "p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.out";
if (-e "$file") { 
open my $fdIn, '<', $file  or die "Unable to open $file: $!\n";
open my $fdOut, '>', "p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.csv" or die "Unable to p${nyuID[$posCount]}_DR7.galfit_$galaxy_fits.csv: $!\n";
