...
open my $aper_all, '>', "haper_S82.sh" or die "cannot open haper_S82.sh $!";


foreach my $posCount (0 .. @nyuID - 1)
#scalar @nyuID - 1
{
	open my $SEXaper_r, '>', "hp$nyuID[$posCount]_S82.aperture.sex" or die "cannot open hp$nyuID[$posCount].aperture.sex $!";
...
print $aper_all "sex p$nyuID[$posCount]_S82.fits -c hp$nyuID[$posCount]_S82.aperture.sex \n";
