...
open my $inPositions, '<', "chpnyu22318_S82.aper.csv" or die "cannot open chpnyu22318_S82.aper.csv: $!";
...
my $image = rfits("mask_1.pnyu22318_S82.fits"); #IMAGE
...
$ellipse->wfits("hmask_1a.pnyu22318_S82.fits");  
$ellipse_2->wfits("hmask_1b.pnyu22318_S82.fits"); 


my $HOT_Mimage_A = rfits("hmask_1a.pnyu22318_S82.fits");
my $HOT_Mimage_B = rfits("hmask_1b.pnyu22318_S82.fits");
my $COLD_Mimage_A = rfits("mask_1a.pnyu22318_S82.fits");
my $COLD_Mimage_B = rfits("mask_1b.pnyu22318_S82.fits");
...
$final_galfit_mask->wfits("FMASK.pnyu22318_S82.fits");

my $final_galfit_mask2 = $COLD_Mimage_B * $HOT_Mimage_B;
$final_galfit_mask2->sethdr($image->hdr);
$final_galfit_mask2->wfits("FMASK_b.pnyu22318_S82.fits");
...
$Un_masked->wfits("MASKED.pnyu22318_S82.fits");
