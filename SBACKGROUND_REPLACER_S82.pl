...
foreach my $posCount (0 .. scalar @nyuID - 1) {
		if ((-e "p${nyuID[$posCount]}_S82.fits") && (-e "p${nyuID[$posCount]}_S82.seg.csv")) {
		print "p${nyuID[$posCount]}_S82.seg.csv","\n";
		open my $inPositions_1, '<', "p${nyuID[$posCount]}_S82.seg.csv" or die "cannot open p${nyuID[$posCount]}_S82.seg.csv: $!"; #object locations to avoid
		...
		my $image = rfits("Good.p${nyuID[$posCount]}_S82.fits"); 
