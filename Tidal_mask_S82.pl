...
open my $inPositions, '<', "tidal_mask.${nyuID[$posCount]}_S82.csv" or die "cannot open tidal_mask.${nyuID[$posCount]}_S82.csv: $!";
...
$ellipse->wfits("tmask_1a.p${nyuID[$posCount]}_S82.fits");  
$ellipse_2->wfits("tmask_1b.p${nyuID[$posCount]}_S82.fits"); 
