...
if (-e "p${nyuID[$posCount]}_S82.fits") {
	
print "p${nyuID[$posCount]}_S82.fits\n";

#NEW MASK USING SEXTRACTOR
open my $inPositions, '<', "HOTMASK.p${nyuID[$posCount]}_S82.csv" or die "cannot open HOTMASK.p${nyuID[$posCount]}_S82.csv: $!";
...
$ellipse->wfits("hmask_1a.p${nyuID[$posCount]}_S82.fits");  
$ellipse_2->wfits("hmask_1b.p${nyuID[$posCount]}_S82.fits"); 


my $HOT_Mimage_A = rfits("hmask_1a.p${nyuID[$posCount]}_S82.fits");
my $HOT_Mimage_B = rfits("hmask_1b.p${nyuID[$posCount]}_S82.fits");
...
$final_galfit_mask->wfits("FMASK.p${nyuID[$posCount]}_S82.fits");
